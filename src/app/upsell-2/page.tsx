...
import { getOrCreateSession, trackUpsell2 } from '../../lib/tracking';
      ...
      <div className="w-full max-w-md mx-auto min-h-screen bg-white shadow-xl border-x border-gray-100 flex flex-col justify-between p-6">
        ...
        <header className="space-y-4 text-center shrink-0">
          <div className="inline-flex items-center gap-1 bg-amber-50 text-amber-700 px-3 py-1 rounded-full text-[10px] font-extrabold uppercase tracking-wider border border-amber-200">
            ...
            <span>Última oferta de hoje</span>
          </div>
          
          <h1 className="text-xl font-black text-gray-900 leading-snug">
            SÓ MAIS UMA COISA... Seu pedido está quase pronto!
          </h1>
          
          <p className="text-xs text-gray-500 font-semibold leading-relaxed">
            Esta é a última etapa antes do seu acesso. Adicione o plano estruturado por um valor promocional.
          </p>
        </header>
        ...
        <main className="flex-1 flex flex-col justify-center py-6 space-y-6">
          ...
          <div className="bg-gray-50 border border-gray-100 rounded-2xl p-5 space-y-4 text-center">
            ...
            <div className="space-y-1">
              <h3 className="font-extrabold text-gray-900 text-base">Plano Alimentar Intestino Sensível</h3>
              <p className="text-xs text-gray-500 font-semibold">Seu cronograma nutricional dia a dia</p>
            </div>
            <p className="text-xs text-gray-600 leading-relaxed">
              Muitas pessoas não sabem o que comer no café, almoço ou jantar. Criamos um cronograma alimentar completo de 4 semanas para blindar a saúde do seu intestino e eliminar dores.
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs text-gray-700 font-medium">
              {[
                'Cardápio semanal completo estruturado.',
                'Substituições fáceis para comer fora de casa.',
                'Lista de compras semanal otimizada.',
                'Guia de reintrodução segura de alimentos.'
              ].map((item, idx) => (
          ...
          <div className="text-center space-y-1">
            <div className="flex items-baseline justify-center gap-1.5">
              <span className="text-[10px] text-gray-400 line-through font-semibold">De R$ 97,00</span>
              <span className="text-xs text-gray-500">Por apenas</span>
              <span className="text-2xl font-black text-gray-900">R$ 37,00</span>
            </div>
            <span className="text-[9px] text-[#2E7D32] font-bold uppercase tracking-wider block">Pagamento único • Acesso vitalício</span>
          </div>
          ...
          <div className="space-y-3">
            ...
            >
              ...
              Não obrigado, quero concluir meu pedido sem este plano.
            </button>
          </div>
        </main>
        ...
        <footer className="py-2 text-center text-[10px] text-gray-400 shrink-0 border-t border-gray-100 flex items-center justify-center gap-1.5 pt-4">
          ...
          <span>Material 100% digital com envio imediato no seu e-mail.</span>
        </footer>
